...
<div class="pageContent">
	<form id="jobId">
		<div class="pageFormContent">
			...
			<td><input name="job_name" type="text" class="required" size="30" value="" alt="请输入计划名称" /></td>	
			</tr><tr>				
			<td>
			<label>计划周期：</label>
			</td>
			<td>
				...
				<option value="${v.CIRCLE_ID}">${v.CIRCLE_NAME}</option>
				</c:forEach>
				</select>
			</td>
			</tr>
			...
			<td>
			<textarea name="content" cols="80" rows="4" class="required" ></textarea>
			</td>
			</tr>
			<tr>
			<td>
			...
			<td>
			<input name="creator" type="text" readonly="readonly" class="required" size="30" value="${staffNo}" />
			</td>
			</tr><tr>
			<td>
			<label>创建日期：</label>
			...
			<td>
			 <input name="create_date" type="text"
					readonly="readonly" class="required" size="30" value="${currentDate}"/>
			</td>
			</tr>
			</table>
		</div>
