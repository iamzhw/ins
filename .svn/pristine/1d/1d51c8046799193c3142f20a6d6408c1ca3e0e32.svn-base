...
public class MatchSiteThread implements Runnable {
	...
	public MatchSiteThread(LineSiteInterfaceDao lineSiteInterfaceDao, ParamService paramService, String jsonStr) {
