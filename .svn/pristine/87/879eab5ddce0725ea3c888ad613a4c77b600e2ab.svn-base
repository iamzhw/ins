	...
	<script type="text/javascript">
		...
		function searchData() {
			...
			$('#dg').datagrid({
				...
				fitColumns:true,
				toolbar : '#tb',
				url : webPath + "xxdReportController/getInspectAr.do",
				queryParams : obj,
				method : 'post',
				//pagination : true,
				//pageNumber : 1,
		...
		function inspectArDownload(){
			...
			window.open(webPath + "xxdReportController/inspectArDownload.do"+getParamsForDownloadLocal('form'));
		}
	</script>
