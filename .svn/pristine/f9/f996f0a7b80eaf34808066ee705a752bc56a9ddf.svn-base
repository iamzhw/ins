	...
	<script type="text/javascript">
		...
		function searchData() {
			...
			$('#dg').datagrid({
				...
				fitColumns:true,
				toolbar : '#tb',
				url : webPath + "xxdReportController/qualityReportByArea.do",
				queryParams : obj,
				method : 'post',
				//pagination : true,
				//pageNumber : 1,
		...
		function inspectArDownload(){
			...
			window.open(webPath + "xxdReportController/qualityReportByAreaDownload.do"+getParamsForDownloadLocal('form'));
		}
	</script>
