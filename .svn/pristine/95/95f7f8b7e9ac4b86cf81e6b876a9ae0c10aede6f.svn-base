...
<body style="padding:3px;border:0px" >
	...
	<div class="condition-container">
		...
		<div class="btn-operation-container" >
			<div class="btn-operation" onClick="query_JHYstaff()" >查询</div>
			<div class="btn-operation" onClick="edit_inspector()">修改</div>
		</div>
	</div>
	...
	<script type="text/javascript">
		...
		function query_JHYstaff() {
			...
			$('#dg_plan').datagrid({
				...
				height : 500,
				toolbar : '#tb_plan',
				url : webPath + "CablePlan/query_JYHstaff.do",
				queryParams : obj,
				method : 'post',
				pagination : true,
				pageNumber : 1,
        ...
        $.messager.confirm('系统提示', '您确定要分配任务吗?', function (r) {
            if (r) {
                ...
                $('#form_task').form('submit', {
                    url: webPath + "CablePlan/edit_inspector.do",
                    onSubmit: function () {
                        $.messager.progress();
                    },
                    success: function () {
