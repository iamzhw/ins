package com.webservice.intelligenceNetworkM;
...
public class Java3 {
	...
	public Java3(Class<?> className) {
		...
		args3 = new String[] { "-o", "IntelligenceNetworkMService.wsdl", "-wsdl",
				this.className.getName() };
	}
	 ...
	 *            要生成WSDL的文件名称（不包含扩展名）
	 */
	public Java3(Class<?> className, String wsdlFileName) {
		this.className = className;
		...
		args3 = new String[] { "-o", wsdlFileName + "IntelligenceNetworkMService.wsdl", "-wsdl",
				this.className.getName() };
	}
	...
	public static void main(String[] args) {
		Java3 java3 = new Java3(IntelligenceNetworkMService.class);
