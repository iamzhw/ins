	...
	<div id="tb" style="padding: 5px; height: auto">
		...
		<div class="btn-operation-container">
			...
			<div style="float: left;" class="btn-operation"
				onClick="keysiteDownload()">导出</div>
	...
	<script type="text/javascript">
		...
		function searchData() {
			...
			$('#dg').datagrid({
				...
				autoSize : true,
				toolbar : '#tb',
				url : webPath + "xxdReportController/getKeysiteComplete.do",
				queryParams : obj,
				method : 'post',
				pagination : true,
				pageNumber : 1,
		...
		function keysiteDownload(){
			
			window.open(webPath + "xxdReportController/keysiteDownload.do"+getParamsForDownloadLocal('form'));
		}
	</script>
