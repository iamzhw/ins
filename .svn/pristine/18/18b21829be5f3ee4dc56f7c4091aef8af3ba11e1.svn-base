...
<html>
	...
	<body style="padding: 3px; border: 0px;">
	 <div style="width:100%;height:100%;">
		<div style="height:30%;">
	        <table id="dg1" title="【设备数量】" style="width: 100%;height: 100px"></table> 
		</div>
		<div style="height:70%;">
	...
	<script type="text/javascript">
		...
		function searchEqp() {
			...
			var columns=[ {
					...
					if (row.RES_TYPE_ID != undefined){
		        	return "<a href=\"javascript:searchData("+ row.RES_TYPE_ID + ");\">"+value+"</a>";
		        	}else{
		        	return value;
		        	}
		        } 
			...
			$('#dg1').datagrid({
				autoSize : true,
				toolbar : '#tb',
				url : webPath + "CheckQualityReport/equipmentNumQuery.do",
				queryParams : obj,
				method : 'post',
				pagination : true,
				pageNumber : 1,
		...
		function searchData(RES_TYPE_ID) {
