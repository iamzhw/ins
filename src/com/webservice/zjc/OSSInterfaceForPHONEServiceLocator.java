...
public class OSSInterfaceForPHONEServiceLocator extends org.apache.axis.client.Service implements com.webservice.zjc.OSSInterfaceForPHONEService {
    ...
    public com.webservice.zjc.IOSSInterfaceForPHONE getOSSInterfaceForPHONEPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.webservice.zjc.IOSSInterfaceForPHONE getOSSInterfaceForPHONEPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.webservice.zjc.OSSInterfaceForPHONEServiceSoapBindingStub _stub = new com.webservice.zjc.OSSInterfaceForPHONEServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.webservice.zjc.IOSSInterfaceForPHONE.class.isAssignableFrom(serviceEndpointInterface)) {
                com.webservice.zjc.OSSInterfaceForPHONEServiceSoapBindingStub _stub = new com.webservice.zjc.OSSInterfaceForPHONEServiceSoapBindingStub(new java.net.URL(OSSInterfaceForPHONEPort_address), this);
                _stub.setPortName(getOSSInterfaceForPHONEPortWSDDServiceName());
                return _stub;
            }
        }
