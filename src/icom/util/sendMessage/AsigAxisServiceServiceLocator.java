...
public class AsigAxisServiceServiceLocator extends org.apache.axis.client.Service implements icom.util.sendMessage.AsigAxisServiceService {
    ...
    private java.lang.String AsigAxisService_address = "http://132.228.169.145:8001/ida/axis/services/AsigAxisService";
    ...
    public icom.util.sendMessage.AsigAxisService_PortType getAsigAxisService() throws javax.xml.rpc.ServiceException {
    ...
    public icom.util.sendMessage.AsigAxisService_PortType getAsigAxisService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            icom.util.sendMessage.AsigAxisServiceSoapBindingStub _stub = new icom.util.sendMessage.AsigAxisServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (icom.util.sendMessage.AsigAxisService_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                icom.util.sendMessage.AsigAxisServiceSoapBindingStub _stub = new icom.util.sendMessage.AsigAxisServiceSoapBindingStub(new java.net.URL(AsigAxisService_address), this);
                _stub.setPortName(getAsigAxisServiceWSDDServiceName());
                return _stub;
            }
        }
