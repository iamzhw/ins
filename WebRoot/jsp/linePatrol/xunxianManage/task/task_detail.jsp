...
<body style="padding: 3px; border: 0px">
	<div class="datagrid-header" style="width: 385px; height: 40px;">
		...
		<span>巡线段</span><span class="datagrid-sort-icon">&nbsp;</span></div>
		</td>
		</tr>
		</tbody>
		</table>
		...
		<td><div style="width: 350px;text-align:center;;white-space:normal;height:auto;" class="datagrid-cell">${v.LINE_NAME}</div></td> 
		</tr>
		</c:forEach>
		</table>
		</div>
