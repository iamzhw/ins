				...
				<table id="tbl1">
					...
					<tr>
						...
						<td><div class="condition-text-container">
								<input
									...
									onchange="setStrokeColor(this.value)" value="${lineInfo.LINE_COLOR}" disabled="disabled"/>
							</div>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td width='60%'><select class='condition-select'
							name='inspect_id' id='inspect_id' disabled="disabled">
...
function delMarker(e,lng,lat,site_type) {
	...
	if(!flag){//未加入到巡线段中
		...
		var markersIds=markersId.join(",")+"";
		 $('#win').window({
				title : "选择巡线点",
				href : webPath + "lineInfoController/getSitesByIdsUI.do?markersIds="+markersIds,
				width : 500,
				height : 400,
				zIndex : 2,
				region : "center",
