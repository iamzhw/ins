...
//            e.overlay.getPath()[0].lng    e.overlay.getPath()[0].lat
           ...
           $.ajax({          
              ...
              //ebWidth=ebWidth.substring(0,ebWidth.indexOf(".")+3)+"米";
              //ebHeight=ebHeight.substring(0,ebHeight.indexOf(".")+3)+"米";
           ...
           var p2lng=p2.lng;
           var p2lat=p2.lat;
           var point0=new BMap.Point(p0lng, p0lat);
           var point1=new BMap.Point(p1lng, p1lat);
           var point2=new BMap.Point(p2lng, p2lat);
           
           alert(p0lng+":"+p1lng+":"+p2lng);
          
           var d1=map.getDistance(point0,point1);
           var d2=map.getDistance(point1,point2);
	...
	$.ajax({          
		  async:false,
		  type:"post",
		  url :webPath + "mainOutSiteController/findById.do",
		  data:{out_site_id:"${out_site_id}"},
		  dataType:"json",
		  success:function(data){
	  ...
	  $(".BMapLib_polygon").remove();
		...
		function add_elebar(){
			...
			$.ajax({          
				  async:false,
				  type:"post",
				  url :webPath + "mainOutSiteController/saveElebar.do",
