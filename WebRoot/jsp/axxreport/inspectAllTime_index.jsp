	...
	<div id="tb" style="padding: 5px; height: auto">
		...
		<div class="btn-operation-container">
			...
			<div style="float: left;" class="btn-operation"
				onClick="inspectTimeDownload()">导出</div>
	...
	<script type="text/javascript">
		...
		function searchData() {
			...
			$('#dg').datagrid({
				...
				fitColumns:true,
				toolbar : '#tb',
				url : webPath + "xxdReportController/getInspectAllTime.do",
				queryParams : obj,
				method : 'post',
				//pagination : true,
				//pageNumber : 1,
				...
				columns : [ [ {
					...
					field : 'AVG_INS_TIME_VALID_ALLDAY',
					title : '全市巡线平均时长',
					width : "20%",
					align : 'center'
				},
		...
		function inspectTimeDownload(){
			...
			window.open(webPath + "xxdReportController/inspectAllTimeDownload.do"+getParamsForDownloadLocal('form'));
		}
	</script>
