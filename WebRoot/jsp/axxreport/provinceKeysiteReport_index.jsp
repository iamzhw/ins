	...
	<script type="text/javascript">
		...
		function searchData() {
			...
			$('#dg').datagrid({
				...
				fitColumns:true,
				toolbar : '#tb',
				url : webPath + "xxdReportController/getProvinceKeysiteComplete.do",
				queryParams : obj,
				method : 'post',
				rownumbers : true,
				singleSelect : false,
		...
		function inspectArDownload(){
			...
			window.open(webPath + "xxdReportController/getProvinceKeysiteCompleteDown.do"+getParamsForDownloadLocal('form'));
		}
	</script>
