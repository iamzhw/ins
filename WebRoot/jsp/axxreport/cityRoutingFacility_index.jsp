	...
	<script type="text/javascript"><!--
		...
		function searchData() {
			...
			$('#dg').datagrid({
				...
				fitColumns:true,
				toolbar : '#tb',
				url : webPath + "xxdReportController/getCityRoutingFacility.do",
				queryParams : obj,
				method : 'post',
				rownumbers : true,
				singleSelect : false,
...
//		}
		...
		if($("#min_time").val()==''){
			...
			window.open(webPath + "xxdReportController/getCityRoutingFacilityDown.do"+getParamsForDownloadLocal('form'));
		}
	</script>
