	...
	<script type="text/javascript">
			...
			$.ajax({
				...
				success : function(json) {
					if(json[0].ifGly==1){			
						...
						$("select[name='area_id']").val(${areaId});
		...
		function searchData() {
			...
			$('#dg').datagrid({
				...
				fitColumns:true,
				toolbar : '#tb',
				url : webPath + "xxdReportController/getProvienceOfStaffData.do",
				queryParams : obj,
				method : 'post',
				//pagination : true,
				//pageNumber : 1,
		...
		function inspectArDownload(){
			...
			window.open(webPath + "xxdReportController/getProvienceOfStaffDataDown.do"+getParamsForDownloadLocal('form'));
		}
	</script>
