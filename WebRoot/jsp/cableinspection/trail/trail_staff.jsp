	...
	<body style="padding: 3px; border: 0px">
		...
		<div id="tb_plan" style="padding: 5px; height: auto">
			...
			<div class="btn-operation-container">
				<div class="btn-operation" onClick="queryStaffby()">
					查询
				</div>
		...
		function queryStaff() {
			...
			$('#dg_plan').datagrid({
				...
				height : 500,
				toolbar : '#tb_plan',
				url : webPath + "CablePlan/query_staff.do",
				queryParams : obj,
				method : 'post',
				pagination : true,
				pageNumber : 1,
...
function submitStaff() {
    ...
    if (count == 0) {
        ...
        return;
                ...
                $("input[name='vstaff_id']").val(selected[0].STAFF_ID);
                $("input[name='vstaff_name']").val(selected[0].STAFF_NAME);
