...
function saveTask(){
	...
	if (count == 0) {
		...
		$.ajax({
			type : 'GET',
			url : webPath + "CableTaskMangerNew/saveTask.do?staffId="+staffId+"&sbIds="+sbIds+"&complete_time="+complete_time+"&dz_start_time="+dz_start_time+"&dz_end_time="+dz_end_time+"&area="+area+"&son_area="+son_area,
			dataType : 'json',
			success : function(json) {
