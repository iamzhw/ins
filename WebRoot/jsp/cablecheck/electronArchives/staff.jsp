...
function saveTask(){
	...
	if (count == 0) {
		...
		$.ajax({
			type : 'GET',
			url : webPath + "CableTaskManger/saveElectronTask.do?staffId="+staffId+"&sbIds="+sbIds+"&complete_time="+complete_time+"&dz_start_time="+dz_start_time+"&dz_end_time="+dz_end_time,
			dataType : 'json',
			success : function(json) {
